import{f as v,b as y,q as b,w as m,g as S,a as g,e as f}from"./index-X9_tESPy.js";function k(o,s){const a=Math.sqrt(Math.pow(o.witty-s.witty,2)+Math.pow(o.dark-s.dark,2)+Math.pow(o.physical-s.physical,2)+Math.pow(o.absurdist-s.absurdist,2)+Math.pow(o.selfDeprecating-s.selfDeprecating,2)),d=Math.sqrt(5*Math.pow(6,2));return Math.round(100-a/d*100)}async function T(o){const s=document.querySelector("#app");s.innerHTML=`
    <div>
